...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="card-cosmic rounded-lg p-8">
            <h2 class="text-2xl font-bold text-white mb-6">Tambah Jurusan Baru</h2>

            <form method="POST" action="{{ route('admin.majors.store') }}" class="space-y-6">
                @csrf
