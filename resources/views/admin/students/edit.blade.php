...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="card-cosmic rounded-lg p-8">
            ...
            <form method="POST" action="{{ route('admin.students.update', $student->id) }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Foto Siswa -->
                    <div>
                        <label for="student_picture" class="block text-sm font-semibold text-purple-200 mb-2">Foto Siswa</label>
                        <input
                            type="file"
                            id="student_picture"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        name="address"
                        rows="4"
                        placeholder="Masukkan address lengkap siswa"
                        class="form-input-cosmic w-full px-4 py-3 rounded-lg"
                        required
