...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="card-cosmic rounded-lg p-8">
            <h2 class="text-2xl font-bold text-white mb-6">Edit Informasi Sekolah: {{ $aboutSchool->nama_sekolah ?? 'N/A' }}</h2>

            <form method="POST" action="{{ route('admin.about-school.update', $aboutSchool->id) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input
                        ...
                        id="nama_sekolah"
                        name="nama_sekolah"
                        value="{{ old('nama_sekolah', $aboutSchool->nama_sekolah ?? '') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="logo_sekolah"
                            name="logo_sekolah"
                            value="{{ old('logo_sekolah', $aboutSchool->logo_sekolah ?? '') }}"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('tentang_jurusan', $aboutSchool->tentang_jurusan ?? '') }}"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="form-input-cosmic w-full px-4 py-3 rounded-lg"
                        required
                    >{{ old('tentang_sekolah', $aboutSchool->tentang_sekolah ?? '') }}</textarea>
